...
| instant_sell_enabled | bool |   | Enable instant sell for this item. Only available for items with the `Verified_Authentic` `json_attribute` set to `"Yes"`. Default is false. |
